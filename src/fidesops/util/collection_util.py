from typing import List, Dict, TypeVar, Iterable, Callable, Any
...
def filter_nonempty_values(d: Dict[Any, Any]) -> Dict[Any, Any]:
    """Return the input map with empty values removed"""
    if d:
