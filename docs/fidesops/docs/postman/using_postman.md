...
1. 1. Run `nox -s dev -- <database>` in your terminal. 
      - This brings up the `fidesops` server and the list of databases specified, i.e. ``nox -s dev -- postgres mongodb`. These mock databases are pre-populated with test data to represent your datastores.
