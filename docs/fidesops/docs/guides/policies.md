...
You will want to create separate Policies that upload to a proper storage destination that target the fields you care about,
and handle the fields in the appropriate way.  But these autogenerated Policies can get you up and running
