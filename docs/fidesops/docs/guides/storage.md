...
Take me directly to [API docs](https://ethyca.github.io/fidesops/api/#operations-Storage-upload_data_api_v1_storage__request_id__post) (you'll need to `make server` first)
...
Let's get started. To create a new StorageConfig, use the following endpoint ([API docs here](https://ethyca.github.io/fidesops/api/#operations-Storage-put_config_api_v1_storage_config_put)):
...
Use the `storage_key` obtained from above in the following endpoint ([api docs here](https://ethyca.github.io/fidesops/api/#operations-Storage-put_config_secrets_api_v1_storage_config__config_key__secret_put)): 
...
To upload data to a storage destination of choice ([api docs here](https://ethyca.github.io/fidesops/api/#operations-Storage-upload_data_api_v1_storage__request_id__post)):
