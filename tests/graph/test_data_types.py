...
def test_string_convert():
    ...
    assert converter.to_value(1) == "1"
    assert converter.to_value(ObjectId("abc123abc123abc123abc123")) == "abc123abc123abc123abc123"
...
def test_object_id_convert():
    ...
    assert converter.to_value("abc123abc123abc123abc123") == ObjectId("abc123abc123abc123abc123")
